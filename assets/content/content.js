...
export const accueil = {
    sectionPhoto: {
        ...
        text: "M.I.L.E.S. Performance est une structure que je veux en<span class='highlighted'> cohérence avec mes valeurs et mon expérience</span> (35 années de sport, dont 24 années à haut-niveau) : c’est avant tout une conception de l’accompagnement à la performance bâtie sur les exigences du sport de haut-niveau.<br><br> Les objectifs et leur préparation font partie de mon quotidien : cela nécessite une démarche et des mécanismes précis (identification, analyse, planification, suivi, adaptation, réactivité) sur lesquels s’appuie ma démarche. <br><br>Si<span class='highlighted'> la performance</span> est une constante du sport de haut-niveau, c’est aussi <span class='highlighted'>un concept qui appartient à toutes et à tous</span> : un projet, un ou des objectifs sportifs, professionnels, et vous êtes dès lors engagé dans une démarche de performance. Par mon expérience, mon challenge est le vôtre : vous accompagner et vous proposer <span class='highlighted'>du sur-mesure pour atteindre et valider vos objectifs.</span>",
        image: {
